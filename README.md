...
https://github.com/step-security/github-actions-pr-is-linked-to-work-item/assets/10525048/1a63ba2d-067b-4f79-b292-b2d1118c43ed
...
jobs:
  create-edit-comment:
    ...
    steps:
      - uses: step-security/github-actions-pr-is-linked-to-work-item@v1
```
